...
type AppMode = 'Mesas' | 'Mostrador' | 'Reportes';
...
export function RootLayout() {
  ...
  const activeMode: AppMode =
    location.pathname === '/reportes' ? 'Reportes' : subMode;
  ...
  return (
    <FavoritesProvider>
    <MesasStoreProvider>
    <div className="flex flex-col h-screen w-full bg-[#F1F2F6] overflow-hidden font-sans">
      <Toaster position="top-center" richColors />
      ...
      {showLogoutModal && (
        ...
        >
          <div style={{
            ...
            <h2 style={{ fontSize: 22, fontWeight: 700, color: '#0F1729', textAlign: 'center', margin: 0, marginBottom: 12 }}>
              Actualmente tienes un turno abierto
            </h2>
            <p style={{ fontSize: 16, color: '#6B7280', textAlign: 'center', margin: 0, marginBottom: 32 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
              <button
                ...
                style={{
                  ...
                  color: '#E63946', fontSize: 16, fontWeight: 600, cursor: 'pointer',
                }}
              ...
              <button
                ...
                onMouseLeave={e => ((e.target as HTMLButtonElement).style.backgroundColor = '#E63946')}
              >
                Cerrar sesión
              </button>
            </div>
      ...
      <div className="fixed bottom-6 right-6 z-50 pointer-events-none">
        <div className="bg-blue-900 text-white px-4 py-2 rounded-full text-xs font-bold shadow-2xl flex items-center gap-2">
