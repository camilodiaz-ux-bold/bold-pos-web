...
export function KitchenTicketPreviewModal({
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-xl shadow-2xl w-[400px] max-h-[92vh] flex flex-col overflow-hidden">
        ...
        {/* ── Subtítulo ── */}
        <p className="px-6 pb-5 shrink-0" style={{ fontSize: 14, color: '#6b7280' }}>
          {isResend
        ...
        {/* ── Botones de acción ── */}
        <div className="flex items-center gap-3 px-6 pt-5 pb-6 shrink-0">
          <button
            onClick={onCancel}
            className="flex-1 py-3 rounded-xl border border-gray-200 bg-white text-sm font-bold text-gray-600 hover:bg-gray-50 transition-all"
          >
            Cancelar
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 py-3 rounded-xl text-sm font-bold text-white flex items-center justify-center gap-2 transition-all hover:opacity-90 shadow-lg shadow-red-500/20"
