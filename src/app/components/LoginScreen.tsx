...
function ReCaptchaWidget({ checked, onToggle }: { checked: boolean; onToggle: () => void }) {
  return (
    <div style={{
      border: '1px solid var(--black-10)', borderRadius: 4, padding: '12px 16px',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <button
          ...
          style={{
            ...
            border: `2px solid ${checked ? "var(--blue-100)" : 'var(--black-10)'}`,
            backgroundColor: checked ? "var(--blue-100)" : '#fff',
        ...
        <span style={{ fontSize: 14, color: 'var(--black-60)', fontWeight: 400 }}>No soy un robot</span>
      </div>
      {/* reCAPTCHA logo */}
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
        ...
        <span style={{ fontSize: 7, color: 'var(--black-40)', lineHeight: 1.2, textAlign: 'center' }}>reCAPTCHA</span>
        <span style={{ fontSize: 6, color: 'var(--black-40)', lineHeight: 1.1, textAlign: 'center' }}>Privacidad · Condiciones</span>
      </div>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Title */}
          <h1 style={{
            fontSize: 28, fontWeight: 400, color: "var(--black-100)",
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={merlinLabel}>
                Correo electrónico{' '}
                <span style={{ color: 'var(--coral-100)' }}>*</span>
              </label>
              <input
                type="email"
                value={email}
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    color: 'var(--black-40)', padding: 4, display: 'flex', alignItems: 'center',
                  }}
                >
            ...
            {/* Forgot password */}
            <p style={{ margin: '14px 0 20px', fontSize: 14, color: "var(--black-60)" }}>
              ¿Olvidaste tu contraseña?{' '}
              <button
                type="button"
                style={{
                  background: 'none', border: 'none', cursor: 'pointer',
                  color: "var(--blue-100)", fontSize: 14, textDecoration: 'underline', padding: 0,
                  fontFamily: "inherit",
                }}
              >
                Recupérala aquí
            ...
            <div style={{ marginBottom: 24 }}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: canLogin ? 'var(--coral-100)' : 'var(--coral-hover)',
                  color: '#fff',
                ...
                onMouseEnter={e => canLogin && ((e.target as HTMLButtonElement).style.backgroundColor = 'var(--coral-hover)')}
                onMouseLeave={e => canLogin && ((e.target as HTMLButtonElement).style.backgroundColor = 'var(--coral-100)')}
              >
                Iniciar sesión
              </button>
            </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: 14, color: "var(--black-60)", fontWeight: 500 }}>
