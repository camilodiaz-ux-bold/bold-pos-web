...
function onFocusMerlin(e: React.FocusEvent<HTMLInputElement>) {
  e.target.style.borderBottomColor = '#121E6C';
}
function onBlurMerlin(e: React.FocusEvent<HTMLInputElement>) {
...
function Feature({ icon, label, sub }: FeatureProps) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
      <div style={{ width: 24, height: 24, color: "var(--black-100)", flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        {icon}
      </div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
        <span style={{ fontSize: 12, color: "var(--black-100)", lineHeight: '16px', fontFamily: 'Montserrat, Inter, sans-serif' }}>
          {label}
        </span>
        {sub && (
          <span style={{ fontSize: 11, color: "var(--black-60)", lineHeight: '14px', fontFamily: 'Montserrat, Inter, sans-serif', textDecoration: 'line-through' }}>
            {sub}
          </span>
        )}
      </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: 32, fontWeight: 700, color: "var(--black-100)", margin: '0 0 8px', lineHeight: 1.2 }}>
            Crea tu cuenta
          </h1>
          <p style={{ margin: '0 0 28px', fontSize: 14, color: "var(--black-60)", fontWeight: 400 }}>
          ...
          {submitted ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, padding: '40px 0' }}>
              ...
              <p style={{ fontSize: 18, fontWeight: 700, color: "var(--black-100)", textAlign: 'center', margin: 0 }}>
                ¡Cuenta creada exitosamente!
              </p>
              <p style={{ fontSize: 14, color: "var(--black-60)", textAlign: 'center', margin: 0 }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
              ...
              <div style={{ marginBottom: 20 }}>
                <label style={MERLIN_LABEL}>
                  Nombre del restaurante <span style={{ color: 'var(--coral-100)' }}>*</span>
                </label>
                <input
                  type="text"
              ...
              <div style={{ display: 'flex', gap: 16, marginBottom: 20 }}>
                ...
                <div style={{ flex: '1 0 0', minWidth: 0 }}>
                  <label style={MERLIN_LABEL}>
                    Teléfono celular <span style={{ color: 'var(--coral-100)' }}>*</span>
                  </label>
                  <div style={{
                    display: 'flex', alignItems: 'center',
                    height: 48,
                    backgroundColor: '#fff',
                    border: `1px solid ${phoneFocused ? "var(--blue-100)" : 'var(--black-10)'}`,
                    borderRadius: 12,
                    overflow: 'hidden',
                    ...
                    <div style={{
                      ...
                      padding: '0 12px',
                      borderRight: '1px solid var(--black-10)',
                      height: '100%', flexShrink: 0,
                    }}>
                      <ColombiaFlag size={20} />
                      <span style={{ fontSize: 14, fontWeight: 500, color: "var(--black-100)", fontFamily: 'Montserrat, Inter, sans-serif', whiteSpace: 'nowrap' }}>
                        +57
                      </span>
                    </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 24 }}>
                <button
                  ...
                  style={{
                    ...
                    border: `2px solid ${termsAccepted ? "var(--blue-100)" : 'var(--black-10)'}`,
                    backgroundColor: termsAccepted ? "var(--blue-100)" : '#fff',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <span style={{ fontSize: 14, color: 'var(--black-60)', fontWeight: 400, fontFamily: 'Montserrat, Inter, sans-serif' }}>
                  Aceptar términos y condiciones{'  '}
                  <button
                    type="button"
                    style={{
                      background: 'none', border: 'none', cursor: 'pointer',
                      fontSize: 14, fontWeight: 600, color: "var(--blue-100)",
              ...
              <div style={{ marginBottom: 24 }}>
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: canSubmit ? 'var(--coral-100)' : 'var(--coral-hover)',
                    color: '#fff', fontSize: 16, fontWeight: 600,
                    fontFamily: 'Montserrat, Inter, sans-serif',
                    transition: 'background-color 0.15s, opacity 0.15s',
                    opacity: canSubmit ? 1 : 0.8,
                  }}
                  onMouseEnter={e => canSubmit && ((e.target as HTMLButtonElement).style.backgroundColor = 'var(--coral-hover)')}
                  onMouseLeave={e => canSubmit && ((e.target as HTMLButtonElement).style.backgroundColor = 'var(--coral-100)')}
                >
                  Crear cuenta
                </button>
              </div>
              ...
              {/* ── Ya tienes cuenta ── */}
              <p style={{ margin: 0, fontSize: 14, color: "var(--black-60)" }}>
                ...
                <button
                  ...
                  style={{
                    background: 'none', border: 'none', cursor: 'pointer',
                    fontSize: 14, fontWeight: 400, color: "var(--blue-100)",
                    textDecoration: 'underline', padding: 0, fontFamily: 'inherit',
                  }}
                >
                  Inicia sesión
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{
              ...
              background: 'linear-gradient(-90deg, #EE424E 4.5%, var(--blue-100) 80%)',
            ...
            <p style={{ margin: 0, fontSize: 16, color: "var(--black-60)", fontFamily: 'Montserrat, Inter, sans-serif' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: 2 }}>
            <span style={{ fontSize: 44, fontWeight: 400, color: "var(--black-100)", lineHeight: '60px', fontFamily: 'Montserrat, Inter, sans-serif' }}>
              $890.000
            </span>
            <span style={{ fontSize: 12, color: "var(--black-100)", lineHeight: '16px', marginBottom: 10, fontFamily: 'Montserrat, Inter, sans-serif' }}>
              /año
            </span>
          </div>
