...
import svgPaths from "./svg-arncfto985";
...
function AtomTextInputFieldsBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-white h-[40px] relative rounded-[12px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative size-full">{children}</div>
      </div>
    </div>
  );
}
...
function BackgroundImage1({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="content-stretch flex gap-[8px] items-start px-[12px] py-[8px] relative size-full">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] font-normal h-full justify-center leading-[0] relative shrink-0 text-[#121e6c] text-[14px] w-[267px]">
...
function BodyAtomDropdownStatusBackgroundImage() {
  return <BackgroundImage>{`Option `}</BackgroundImage>;
}
type BodyAtomDropdownStatusBackgroundImageAndTextProps = {
  text: string;
  additionalClassNames?: string;
};

function BodyAtomDropdownStatusBackgroundImageAndText({ text, additionalClassNames = "" }: BodyAtomDropdownStatusBackgroundImageAndTextProps) {
  return (
...
function BodyBackgroundImage() {
  return (
    <svg fill="none" preserveAspectRatio="none" viewBox="0 0 20 11.6667" className="absolute block size-full">
...
export default function Form() {
  return (
    <div className="relative size-full" data-name="Form 2" style={{ backgroundImage: "linear-gradient(90deg, rgba(247, 248, 251, 0.2) 0%, rgba(247, 248, 251, 0.2) 100%), linear-gradient(123.413deg, rgba(8, 14, 255, 0.1) 0%, rgba(255, 255, 255, 0.03) 51.571%, rgba(8, 14, 255, 0.2) 101.2%), linear-gradient(90deg, rgb(247, 248, 251) 0%, rgb(247, 248, 251) 100%)" }}>
      ...
      <div className="absolute content-stretch flex flex-col gap-[24px] h-[779px] items-center justify-center left-0 top-[80px] w-[1280px]">
        ...
        <div className="content-stretch flex flex-[1_0_0] flex-col gap-[48px] items-start min-h-px min-w-px overflow-clip relative w-[484px]" data-name="Body">
          <div className="content-stretch flex flex-col gap-[8px] items-center justify-center relative shrink-0 w-[484px]" data-name="WEB Panel / Navigation Header">
            <p className="font-['Montserrat:Bold',sans-serif] font-bold h-[20px] leading-[24px] relative shrink-0 text-[#121e6c] text-[20px] w-full">¿Dónde naciste?</p>
            <div className="flex flex-col font-['Montserrat:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1e1e1e] text-[14px] w-full">
              <p className="leading-[20px]">Tal como aparece en tu documento de identidad.</p>
            </div>
          </div>
          <div className="relative shrink-0 w-full" data-name="Forms">
            <div className="content-stretch flex flex-col gap-[32px] items-start relative w-full">
              <TextInputsBackgroundImage>
                <BodyAtomTextInputLabelsBackgroundImageAndText text="País de nacimiento" />
                <AtomTextInputFieldsBackgroundImage>
                  <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name=".atom/text_input_labels">
                    <div className="absolute flex flex-col font-['Montserrat:Medium',sans-serif] font-medium inset-0 justify-center leading-[0] text-[#1e1e1e] text-[14px]">
                      <p className="leading-[20px]">Colombia</p>
                    </div>
                  </div>
              ...
              <TextInputsBackgroundImage>
                <BodyAtomTextInputLabelsBackgroundImageAndText text="Ciudad de nacimiento" />
                <AtomTextInputFieldsBackgroundImage>
                  <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name=".atom/text_input_labels">
                    <div className="absolute flex flex-col font-['Montserrat:Regular',sans-serif] font-normal inset-0 justify-center leading-[0] text-[#606060] text-[14px]">
                      <p className="leading-[20px]">Selecciona una ciudad</p>
                    </div>
                  </div>
                  <div className="relative shrink-0 size-[24px]" data-name="icon/ic_chevron">
                    <div className="absolute bottom-[26.39%] flex items-center justify-center left-[8.33%] right-[8.33%] top-1/4">
                      <div className="flex-none h-[11.667px] rotate-180 w-[20px]">
                ...
                <div className="bg-white relative rounded-[12px] shadow-[0px_8px_20px_0px_rgba(18,30,108,0.08)] shrink-0 w-full" data-name=".atom/dropdown_list">
                  <div className="flex flex-col justify-center size-full">
                    <div className="content-stretch flex flex-col gap-[10px] items-start justify-center p-[12px] relative w-full">
                      <BodyAtomDropdownStatusBackgroundImageAndText text="Barrancabermeja" additionalClassNames="bg-[#f7f8fb]" />
                      <BodyAtomDropdownStatusBackgroundImageAndText text="Barranquilla" additionalClassNames="bg-white" />
                      <BodyAtomDropdownStatusBackgroundImageAndText text="Bello" additionalClassNames="bg-white" />
                      <BackgroundImage>{`Bogotá D.C. `}</BackgroundImage>
                      <BackgroundImage>{`Bucaramange `}</BackgroundImage>
                      <BodyAtomDropdownStatusBackgroundImageAndText text="Buenaventura" additionalClassNames="bg-white" />
                      <BodyAtomDropdownStatusBackgroundImage />
                      <BodyAtomDropdownStatusBackgroundImage />
                      <BodyAtomDropdownStatusBackgroundImage />
                      <BodyAtomDropdownStatusBackgroundImage />
                    </div>
